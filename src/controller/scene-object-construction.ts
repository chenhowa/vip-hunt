...
import {wade, SceneObject, Sprite, Animation, IsoCharacter } from "../custom_types/wade";
...
const SceneObjectConstruction = {
    ...
    barracks: () => {
        const objectData = {
            sprites: [wade.getJson(JsonMap.barracks_1)],
            gridSize: {x: 2, z: 2},
    ...
    stables: () => {
        const objectData = {
            sprites: [wade.getJson(JsonMap.stables_1)],
            gridSize: {x: 2, z: 2},
            collisionSize: {x: 2, z: 2},
    ...
    tower: () => {
        const objectData = {
            sprites: [wade.getJson(JsonMap.towers_1)],
            gridSize: {x: 1, z: 1},
    ...
    VIP: () => {
        const objectData = {
            sprites: [wade.getJson(JsonMap.vip_1)],
            gridSize: {x: 1, z: 1},
            // collisionSize: {x: 1, z: 1},
    ...
    townHall: () => {
        const objectData = {
            sprites: [wade.getJson(JsonMap.town_halls_1)],
            gridSize: {x: 2, z: 2},
            collisionSize: {x: 2, z: 2},
        };
        objectData.sprites.push(wade.getJson(JsonMap.selected_marker));
    ...
    swordsman: () => {
        const objectData = {
            sprites: [wade.getJson(JsonMap.swordsman_1)],
            gridSize: {x: 1, z: 1},
            // collisionSize: {x: 1, z: 1},
            behaviors: [IsoCharacter],
        };
    ...
    archer: () => {
        const objectData = {
            sprites: [wade.getJson(JsonMap.archer_1)],
            gridSize: {x: 1, z: 1},
            // collisionSize: {x: 1, z: 1},
            behaviors: [IsoCharacter],
        };
    ...
    archerCalvary: () => {
        const objectData = {
            sprites: [wade.getJson(JsonMap.archer_calvary_1)],
            gridSize: {x: 1, z: 1},
            // collisionSize: {x: 1, z: 1},
            behaviors: [IsoCharacter],
        };
    ...
    spearCalvary: () => {
        const objectData = {
            sprites: [wade.getJson(JsonMap.spear_calvary_1)],
            gridSize: {x: 1, z: 1},
            // collisionSize: {x: 1, z: 1},
            behaviors: [IsoCharacter],
        };
    ...
    gatherer: () => {
        const objectData = {
            sprites: [wade.getJson(JsonMap.gatherer_1)],
            gridSize: {x: 1, z: 1},
            // collisionSize: {x: 1, z: 1},
            behaviors: [IsoCharacter],
        };
    ...
    drummerBoy: () => {
        const objectData = {
            sprites: [wade.getJson(JsonMap.drummer_boy_1)],
            gridSize: {x: 1, z: 1},
            // collisionSize: {x: 1, z: 1},
            behaviors: [IsoCharacter],
        };
    ...
    stone: () => {
        const objectData = {
            sprites: [wade.getJson(JsonMap.stone)],
            gridSize: {x: 1, z: 1},
            collisionSize: {x: 1, z: 1},
        };
    ...
    wood: () => {
        const objectData = {
            sprites: [wade.getJson(JsonMap.wood)],
            gridSize: {x: 1, z: 1},
            collisionSize: {x: 1, z: 1},
        };
    ...
    food: () => {
        const objectData = {
            sprites: [wade.getJson(JsonMap.food)],
            gridSize: {x: 1, z: 1},
            collisionSize: {x: 1, z: 1},
        };
