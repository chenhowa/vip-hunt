...
declare namespace wade {
    ...
    let iso: {
        createObject(objectData?: any, gridCoords?: any, instanceData?: any): SceneObject;
    };
...
declare var IsoCharacter;

declare class Path {

}

export { wade, SceneObject, Sprite, Animation, TextSprite, IsoCharacter };
